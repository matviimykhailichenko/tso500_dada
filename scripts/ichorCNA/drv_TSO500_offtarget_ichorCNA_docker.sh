...
bash "${script_dir}"/TSO500_ichorCNA_from_offtarget_reads_PARALLEL.sh -idir "${input_path}" -phmm "${path_hmm}" -pichor "${path_to_ichor}" 2>&1 | tee "${input_path}"/TSO500_liquid_offtarget_ichorCNA.log
