...
from helpers import is_server_available, get_server_ip, get_repo_root
...
def main():
    ...
    if not is_server_available(repo_root=repo_root) or not queue_file.stat().st_size < 38 or not pending_file.stat().st_size < 38:
        return
