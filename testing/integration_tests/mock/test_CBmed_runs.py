...
def setup_environment():
    ...
    test_pending_file = Path('/mnt/Novaseq/TSO_pipeline/03_Production/testing/integration_tests/mock/PENDING_cbmed_runs.txt')
    test_cbmed_run_1:Path = Path('/mnt/Novaseq/TSO_pipeline/03_Production/testing/integration_tests/mock/test_run_cbmed_1')
    test_cbmed_run_2:Path = Path('/mnt/Novaseq/TSO_pipeline/03_Production/testing/integration_tests/mock/test_run_cbmed_2')
